              ...
              text={
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <Typography variant="xs">
                      {i18n._(
                        t`Uniswapper tokens function similar to mintable tokens but with additional capabilities built into the token. Creators will have to assign an owner address for token functions during minting.`
                      )}
                    </Typography>
                  </div>
                  <div className="flex flex-col gap-1">
                    ...
                    <Typography variant="xs">
                      {i18n._(
                        t`Auctioneer used a custom token contract. This contract is not a template and therefore not audited by Uniswapper.`
                      )}
                    </Typography>
                  </div>
                </div>
