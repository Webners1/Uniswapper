    ...
    <>
      ...
      <TridentBody>
        <div className="space-y-5">
          ...
          <div className="grid grid-flow-col gap-4 overflow-auto grid-col-4">
            <InfoCard text="Uniswapper Served 1m" number={formatNumber(fees1m, false)} />
            <InfoCard text="Uniswapper Served 3m" number={formatNumber(fees3m, false)} />
            <InfoCard text="Uniswapper Served 6m" number={formatNumber(fees6m, false)} />
          </div>
